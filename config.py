...
LOG_GROUP_ID = int(os.environ.get('LOG_GROUP_ID', -1001646246141))
GBAN_LOG_GROUP_ID = int(os.environ.get('GBAN_LOG_GROUP_ID', -1001646246141))
MESSAGE_DUMP_CHAT = int(os.environ.get('MESSAGE_DUMP_CHAT', -1001646246141))
WELCOME_DELAY_KICK_SEC = int(os.environ.get('WELCOME_DELAY_KICK_SEC', 600))
MONGO_URL = os.environ.get('mongodb+srv://Ai:Ai@cluster0.892cnzo.mongodb.net/?retryWrites=true&w=majority')
